...
-- Demo ortamında yönetim panelinin görülebilmesi için Ayşe platform yöneticisidir.
-- Üretimde bu atama uygulama üzerinden değil kontrollü DBA/kurulum adımıyla yapılır.
