...
"questions_instructor_delete acilirsa|DROP POLICY questions_instructor_delete ON questions; CREATE POLICY questions_instructor_delete ON questions FOR DELETE USING (true);|questions_delete__ogrenci_soru_silemez"
