...
| Backend testleri | yeşil | **825 geçiyor** (`uv run pytest -q`) | — | <!-- docs-check: backend.tests = 825 -->
=======
...
| Backend testleri | yeşil | **664 geçiyor** (`uv run pytest -q`, 9 Ağu akşamı, beş şerit birleşik) | — |
>>>>>>> origin/docs/refresh-after-merge
