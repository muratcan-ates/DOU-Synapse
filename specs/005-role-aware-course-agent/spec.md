...
**Status**: Backend, `0015` ve frontend kodlandı; tam API 2159/2159, mypy 124 dosya, <!-- docs-check: backend.tests = 2159 --><!-- docs-check: backend.mypyFiles = 124 -->
frontend 672/672, typecheck ve production build geçti. <!-- docs-check: frontend.tests = 672 --> Seri gerçek-API tarayıcı
