...
**Status**: Backend, `0015` ve frontend kodlandı; tam API 910/910, mypy 97 dosya, <!-- docs-check: backend.tests = 910 --><!-- docs-check: backend.mypyFiles = 97 -->
frontend 395/395, typecheck ve production build geçti. <!-- docs-check: frontend.tests = 395 --> Seri gerçek-API tarayıcı
