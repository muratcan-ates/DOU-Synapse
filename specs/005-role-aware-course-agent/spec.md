...
**Status**: Backend, `0015` ve frontend kodlandı; tam API 1212/1212, mypy 105 dosya, <!-- docs-check: backend.tests = 1212 --><!-- docs-check: backend.mypyFiles = 105 -->
frontend 432/432, typecheck ve production build geçti. <!-- docs-check: frontend.tests = 432 --> Seri gerçek-API tarayıcı
