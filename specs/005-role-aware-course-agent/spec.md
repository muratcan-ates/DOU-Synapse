...
**Status**: Backend, `0015` ve frontend kodlandı; güncel API koleksiyonu 1693 testtir; koşum durumu [test raporunda](../../docs/test-report.md), mypy 114 dosya, <!-- docs-check: backend.tests = 1693 --><!-- docs-check: backend.mypyFiles = 114 -->
