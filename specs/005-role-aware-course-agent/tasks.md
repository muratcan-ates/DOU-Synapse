...
final R4 aday bağı henüz açık. DB/RLS mutasyon betiği izole veritabanlarında
...
- [ ] **T409** 005 R3 dossier exact base/head, prompt/model/provider/retrieval/
  ...
  hash'ine bağlar.
  Geçici fake-provider mekanik kanıtı PASS; real-provider/staging iddiaları açıkça
