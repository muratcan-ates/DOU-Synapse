...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 2159) · `bun test` (`apps/web/lib/` → 672) · Playwright (`apps/web/e2e/`, 87 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 2159 --><!-- docs-check: frontend.tests = 672 --><!-- docs-check: e2e.tests = 87 -->
