...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest --collect-only -q` → 1701 toplanan vaka) · `bun test` (`apps/web/lib/` → 573) · Playwright (`apps/web/e2e/`, 71 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1701 --><!-- docs-check: frontend.tests = 573 --><!-- docs-check: e2e.tests = 71 -->
