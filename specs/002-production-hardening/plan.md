...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 2197) · `bun test` (`apps/web/lib/` → 684) · Playwright (`apps/web/e2e/`, 87 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 2197 --><!-- docs-check: frontend.tests = 684 --><!-- docs-check: e2e.tests = 87 -->
