...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1934) · `bun test` (`apps/web/lib/` → 632) · Playwright (`apps/web/e2e/`, 82 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1934 --><!-- docs-check: frontend.tests = 632 --><!-- docs-check: e2e.tests = 82 -->
