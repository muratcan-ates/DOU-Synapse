...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1212) · `bun test` (`apps/web/lib/` → 432) · Playwright (`apps/web/e2e/`, 42 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1212 --><!-- docs-check: frontend.tests = 432 --><!-- docs-check: e2e.tests = 42 -->
