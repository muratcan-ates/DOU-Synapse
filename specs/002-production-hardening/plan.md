...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 910) · `bun test` (`apps/web/lib/` → 395) · Playwright (`apps/web/e2e/`, 38 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 910 --><!-- docs-check: frontend.tests = 395 --><!-- docs-check: e2e.tests = 38 -->
