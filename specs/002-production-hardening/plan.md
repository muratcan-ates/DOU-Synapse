...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 894) · `bun test` (`apps/web/lib/` → 349) · Playwright (`apps/web/e2e/`, 36 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 894 --><!-- docs-check: frontend.tests = 349 --><!-- docs-check: e2e.tests = 36 -->
