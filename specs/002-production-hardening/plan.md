...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1332) · `bun test` (`apps/web/lib/` → 501) · Playwright (`apps/web/e2e/`, 50 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1332 --><!-- docs-check: frontend.tests = 501 --><!-- docs-check: e2e.tests = 50 -->
