...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 2147) · `bun test` (`apps/web/lib/` → 648) · Playwright (`apps/web/e2e/`, 87 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 2147 --><!-- docs-check: frontend.tests = 648 --><!-- docs-check: e2e.tests = 87 -->
