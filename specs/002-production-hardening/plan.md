...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1907) · `bun test` (`apps/web/lib/` → 632) · Playwright (`apps/web/e2e/`, 81 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1907 --><!-- docs-check: frontend.tests = 632 --><!-- docs-check: e2e.tests = 81 -->
