...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 677) · `bun test` (`apps/web/lib/` → 216) · Playwright (`apps/web/e2e/`, 19 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor)
