...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1191) · `bun test` (`apps/web/lib/` → 428) · Playwright (`apps/web/e2e/`, 41 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1191 --><!-- docs-check: frontend.tests = 428 --><!-- docs-check: e2e.tests = 41 -->
