...
**Testing**: pytest (`apps/api/tests/`, bugün 664 test) · `bun test` (`apps/web/lib/`, 211 test) · Playwright (`apps/web/e2e/`, 19 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor)
