...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 904) · `bun test` (`apps/web/lib/` → 352) · Playwright (`apps/web/e2e/`, 36 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 904 --><!-- docs-check: frontend.tests = 352 --><!-- docs-check: e2e.tests = 36 -->
