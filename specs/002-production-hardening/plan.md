...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 850) · `bun test` (`apps/web/lib/` → 311) · Playwright (`apps/web/e2e/`, 33 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 850 --><!-- docs-check: frontend.tests = 311 --><!-- docs-check: e2e.tests = 33 -->
