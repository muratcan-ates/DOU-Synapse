...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 1715) · `bun test` (`apps/web/lib/` → 573) · Playwright (`apps/web/e2e/`, 71 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 1715 --><!-- docs-check: frontend.tests = 573 --><!-- docs-check: e2e.tests = 71 -->
