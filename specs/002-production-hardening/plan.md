...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 915) · `bun test` (`apps/web/lib/` → 398) · Playwright (`apps/web/e2e/`, 36 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 915 --><!-- docs-check: frontend.tests = 398 --><!-- docs-check: e2e.tests = 36 -->
