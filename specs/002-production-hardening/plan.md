...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 961) · `bun test` (`apps/web/lib/` → 402) · Playwright (`apps/web/e2e/`, 36 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 961 --><!-- docs-check: frontend.tests = 402 --><!-- docs-check: e2e.tests = 36 -->
