...
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 946) · `bun test` (`apps/web/lib/` → 406) · Playwright (`apps/web/e2e/`, 37 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 946 --><!-- docs-check: frontend.tests = 406 --><!-- docs-check: e2e.tests = 37 -->
