...
Depoda **17 migration dosyası** var (`0001`'den `0015`'e, aralıksız); hepsi tablo <!-- docs-check: migrations.count = 17 -->
...
```bash
cd apps/api
uv run pytest          # 1040 test yeşil olmalı (~50-100 sn)   # docs-check: backend.tests = 1040
