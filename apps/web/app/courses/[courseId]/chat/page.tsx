  ...
  return (
    <>
      <AssistantIdentitySummary
        ...
        hintLimit={hintLimit}
      />
      {/* `minmax(0,1fr)` + `min-w-0` zorunlu: sade `1fr` = `minmax(auto,1fr)` ve o
         `auto`, sütunun içeriğin min-content genişliğinin altına inmesini yasaklar.
         Ölçüldü (375px): kapsayıcı 343px iken sütun 551px'e şişip belgeyi yana kaydırıyordu. */}
