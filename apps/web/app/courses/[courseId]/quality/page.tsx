  ...
  return (
    <Card variant="flat" padding="none">
      <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-5 sm:px-6">
        <h2 className="text-lg font-semibold text-fg">Paylaşılan inceleme kuyruğu</h2>
        <span className="text-sm tabular-nums text-fg-muted">{reports.length} yanıt</span>
      </div>
      <ul className="divide-y divide-border border-t border-border">
        {reports.map((report) => (
          <li key={report.id} className="px-5 py-6 sm:px-6">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="flex flex-wrap items-center gap-3">
                <p className="text-lg font-semibold text-fg">{report.student_name}</p>
            ...
            {report.question_excerpt && (
              <div className="mt-5 rounded-xl bg-surface-sunken p-4">
                <p className="text-sm font-medium text-fg-muted">Öğrencinin sorusu</p>
                <p className="prose-tr mt-2 text-base leading-relaxed text-fg">{report.question_excerpt}</p>
              </div>
            )}
            <div className="mt-5 rounded-xl bg-surface-sunken p-4">
              <p className="text-sm font-medium text-fg-muted">Asistanın yanıtı</p>
              <p className="prose-tr mt-2 text-base leading-relaxed whitespace-pre-line text-fg">
