...
İşlem ölçümleri, sohbet metnini kaydetmek için kullanılmaz. Bununla birlikte kimlikler ve işlem zamanları kişisel veri olabilir. Beklenmeyen hata ve sunucu hata kayıtlarında ayrıntılı metin yerine sınırlı teknik özetler kullanılır; günlük çıktısının biçimlendirilmesi veya yazılması hata verirse yalnız sabit bir hata işareti yazılmaya çalışılır. Diğer günlüklerde bilinen hassas kalıplar maskelenir; bu, bütün serbest metnin otomatik olarak anonimleştiği anlamına gelmez. Destek kodu sunucu tarafından ilgili istek için üretilir; istemcinin gönderdiği izleme değeri bu amaçla kullanılmaz. Yeniden denemede kod değişebilir. Kod yine hesap, zaman veya işlemle ilişkilendirilebilir; anonim veri olduğu varsayılmaz. Altyapı ve hizmet sağlayıcı günlüklerinin erişim, saklama ve silme kapsamı ayrıca belirlenmelidir.
