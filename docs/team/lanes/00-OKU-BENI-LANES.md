...
| `L2-product.md` | Ürün: blueprint, neden-yanlış, learning_events | `018-l2-product` | 050–059 | 0027 |
| `L3-deploy.md` | Deploy, göç runner, imaj, rollback | `018-l3-deploy` | 060–069 | — |
| `L4-retrieval-ops.md` | Retrieval, kota, worker, ölçüm | `018-l4-retrieval-ops` | 070–079 | 0028 |
| `L5-auth-storage.md` | Kimlik, private Storage | `018-l5-auth` | 080–089 | 0029 |
...
**Göç numaraları (14 Eylül 00:30 düzeltildi):** Şeritler dosyalarındaki numaraları kullanır: L2 0027, L4 0028, L5 0029.
13 Eylül'de yedek daldan kurtarma için 0027/0028'in ayrıldığı yazılmıştı; kurtarma hiç başlamadı, dalları boş silindi.
