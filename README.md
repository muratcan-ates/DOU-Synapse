...
![Backend tests](https://img.shields.io/badge/backend_tests-1918_ge%C3%A7ti-brightgreen) <!-- docs-check: backend.tests = 1918 -->
...
|---|---:|---|
| Backend testleri | **1918** <!-- docs-check: backend.tests = 1918 --> | Repo sözleşmeleri ve deterministik mekanik davranış; gerçek LLM kalitesi değil |
...
Güncel feature kanıtında backend koleksiyonu 1918 testtir; 38 alt vaka ayrıca raporlanır. <!-- docs-check: backend.tests = 1918 -->
