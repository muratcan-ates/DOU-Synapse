...
![Backend tests](https://img.shields.io/badge/backend_tests-1819_toplanan-blue) <!-- docs-check: backend.tests = 1819 -->
![Frontend tests](https://img.shields.io/badge/frontend_tests-621_ge%C3%A7ti-brightgreen) <!-- docs-check: frontend.tests = 621 -->
...
|---|---:|---|
| Backend testleri | **1819** <!-- docs-check: backend.tests = 1819 --> | Repo sözleşmeleri ve deterministik mekanik davranış; gerçek LLM kalitesi değil |
| Frontend birim testleri | **621** <!-- docs-check: frontend.tests = 621 --> | 48 test dosyasındaki UI yardımcıları/sözleşmeleri; tek başına pedagojik kalite kanıtı değil <!-- docs-check: frontend.testFiles = 48 --> |
| Playwright tarayıcı vakaları | **81** <!-- docs-check: e2e.tests = 81 --> | Sayı `playwright test --list` ile toplanan vakalardır. |
...
8 Eylül 2026 tarihli yerel OPS turunda 71 geçti; yeni 3 vakanın 1’i gerçek yetkili API yanıtı, 2’si kontrollü dependency yanıtını gösteren UI sözleşmesidir. c45 hosted 68 sonucu yeni kaynağı kapsamaz. [018 doğrulaması](specs/018-codex-production-line/verification.md) <!-- docs-check: tarihsel 71 · 2026-09-08 -->
...
<code>0001,0002,0003,0004,0005,0006,0007,0008,0009,0010,0011,0012,0013,0014,0015,0016,0018,0019,0020,0024,0025,0026,0027</code> <!-- docs-check: migrations.list = 0001,0002,0003,0004,0005,0006,0007,0008,0009,0010,0011,0012,0013,0014,0015,0016,0018,0019,0020,0024,0025,0026,0027 -->
...
Güncel feature kanıtında backend koleksiyonu 1819 testtir; 38 alt vaka ayrıca raporlanır. <!-- docs-check: backend.tests = 1819 -->
...
Güncel feature kanıtında frontend kütüphane paketi 621 testtir. <!-- docs-check: frontend.tests = 621 -->
...
supabase/
  migrations/              23 göç; şema, RLS, kota ve claim/lease sözleşmeleri
