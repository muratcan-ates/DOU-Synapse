...
![Backend tests](https://img.shields.io/badge/backend_tests-1693_collected-blue) <!-- docs-check: backend.tests = 1693 -->
...
|---|---:|---|
| Toplanan backend testleri | **1693** <!-- docs-check: backend.tests = 1693 --> | Koleksiyon sayısıdır; son başarılı/başarısız koşular ve kapsamı [test raporunda](docs/test-report.md) yer alır |
...
Güncel feature kanıtında backend koleksiyonu 1693 testtir; 38 alt vaka ayrıca raporlanır. <!-- docs-check: backend.tests = 1693 -->
