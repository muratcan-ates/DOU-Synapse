...
![Backend tests](https://img.shields.io/badge/backend_tests-2134_ge%C3%A7ti-brightgreen) <!-- docs-check: backend.tests = 2134 -->
...
|---|---:|---|
| Backend testleri | **2134** <!-- docs-check: backend.tests = 2134 --> | Repo sözleşmeleri ve deterministik mekanik davranış; gerçek LLM kalitesi değil |
...
Güncel feature kanıtında backend koleksiyonu 2134 testtir; 38 alt vaka ayrıca raporlanır. <!-- docs-check: backend.tests = 2134 -->
