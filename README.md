...
![Backend tests](https://img.shields.io/badge/backend_tests-2142_ge%C3%A7ti-brightgreen) <!-- docs-check: backend.tests = 2142 -->
...
|---|---:|---|
| Backend testleri | **2142** <!-- docs-check: backend.tests = 2142 --> | Repo sözleşmeleri ve deterministik mekanik davranış; gerçek LLM kalitesi değil |
...
Güncel feature kanıtında backend koleksiyonu 2142 testtir; 38 alt vaka ayrıca raporlanır. <!-- docs-check: backend.tests = 2142 -->
