...
![Backend tests](https://img.shields.io/badge/backend_tests-1561_ge%C3%A7ti-brightgreen) <!-- docs-check: backend.tests = 1561 -->
...
|---|---:|---|
| Backend testleri | **1561** <!-- docs-check: backend.tests = 1561 --> | Repo sözleşmeleri ve deterministik mekanik davranış; gerçek LLM kalitesi değil |
...
Güncel feature kanıtında backend koleksiyonu 1561 testtir. <!-- docs-check: backend.tests = 1561 -->
