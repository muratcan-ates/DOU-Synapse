...
doğrulanmadan ve gerçek provider/staging kapıları koşulmadan production kanıtı
değildir.
...
- Yerel fake/mutasyon/yük sonuçlarını bağlayan final R4 dossier'ın exact candidate
  üzerinde doğrulanması.
