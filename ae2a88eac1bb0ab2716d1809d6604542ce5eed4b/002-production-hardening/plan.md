...
=======
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 794) · `bun test` (`apps/web/lib/` → 288) · Playwright (`apps/web/e2e/`, 22 vaka) · RLS: 99 çekirdek + 59 ölçme + 37 blueprint iddiası; 53 + 24 + 23 mutasyonla doğrulanıyor <!-- docs-check: backend.tests = 794 --><!-- docs-check: frontend.tests = 288 --><!-- docs-check: e2e.tests = 22 -->
