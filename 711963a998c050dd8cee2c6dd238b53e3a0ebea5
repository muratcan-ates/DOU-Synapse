...
<<<<<<< HEAD
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 825) · `bun test` (`apps/web/lib/` → 290) · Playwright (`apps/web/e2e/`, 21 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 825 --><!-- docs-check: frontend.tests = 290 --><!-- docs-check: e2e.tests = 21 -->
=======
**Testing**: pytest (`apps/api/tests/`, `uv run pytest -q` → 841) · `bun test` (`apps/web/lib/` → 301) · Playwright (`apps/web/e2e/`, 28 vaka) · `supabase/tests/rls_isolation.sql` (98 iddia, mutasyonla doğrulanıyor) <!-- docs-check: backend.tests = 841 --><!-- docs-check: frontend.tests = 301 --><!-- docs-check: e2e.tests = 28 -->
>>>>>>> 8620091 (Refresh the measured portal release contract)
